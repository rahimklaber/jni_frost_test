...
use secp256k1::{Message, hashes::{sha256, Hash}, XOnlyPublicKey};
use sha2::{Sha256, Digest};
use crate::{SchnorrKeyGenWrapper, ResultKeygen1, ResultKeygen2, SchnorrSignWrapper, SignParams2, SchnorrSingleSignTest};
...
fn test() {
    ...
    let sign_res_2_m_1 = SchnorrSignWrapper::sign_2_sign_normal(sign_wrapper_1, param_m1, digest_i8);
    ...
    let sign_res_2_m_2 = SchnorrSignWrapper::sign_2_sign_normal(sign_wrapper_2, param_m2, digest_i8);
