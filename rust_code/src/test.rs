...
// #[test]
// fn test() {
//     let mut tx = deserialize::<Transaction>(hex::decode("").unwrap().as_slice()).unwrap();
...
//     // let secp_key_pair = secp256k1::KeyPair::from_seckey_slice(secp,res3m1.key.secret_share().to_bytes().as_ref()).unwrap();
//     // let tweak = TapTweakHash::from_key_and_tweak(pubkey_obj, None).to_scalar().to_be_bytes();
//     // res3m1.key.offset(Scalar::from_uint_reduced(U256::from_be_slice(&tweak)));
//
