...
fn test() {
    ...
    // let sign_res_2_m_1 = SchnorrSignWrapper::sign_2_sign_old(sign_wrapper_1, param_m1, digest_i8);
    //
    ...
    // let sign_res_2_m_2 = SchnorrSignWrapper::sign_2_sign_old(sign_wrapper_2, param_m2, digest_i8);
    //
